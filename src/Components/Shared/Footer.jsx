            ...
            <section className="mx-auto w-11/12 gap-5 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3  py-8 lg:grid-cols-4 ">
                <nav className='space-y-3'>
                    ...
                    <div className='flex flex-col gap-2'>
                        <a className="link link-hover text-white hover:text-blue-400">About us</a>
                        <a className="link link-hover text-white hover:text-blue-400">Contact</a>
                        <a className="link link-hover text-white hover:text-blue-400">Out Team</a>
                    </div>
                </nav>
                <nav >
                    <h1 className="footer-title ">Contact us</h1>
                    <p className='text-sm text-white/80'>Sylhet, Sunamganj, Dowarabazar-3070</p>
                    ...
                    <fieldset className="w-80">
                        <TextField className="w-full max-w-[280px]" name="email" aria-label='Massage box for user'>
                            ...
                            <InputGroup className='bg-white/10'>
                                ...
                                <InputGroup.Input aria-label="Email Address, enter your email" className="w-full max-w-[280px]" placeholder="Enter you email" />
